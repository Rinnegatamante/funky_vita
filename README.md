...
This is a wrapper/port of <b>Funky Smugglers</b> for the *PS Vita*.
...
This wrapper has been tested only with v.1.06 since it's the sole version [still available for purchase on Amazon AppStore](https://www.amazon.com/11-bit-studios-S-A-Smugglers/dp/B009ZITGR6).
...
- Made so that it's possible to pause game by pressing the Start button.
